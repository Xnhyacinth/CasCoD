...
# def compute_metrics_full(task_descs, task_names, teacher_responses, model_inputs, original_inputs, original_outputs, model_outputs, eval_preds):
def compute_metrics_full(rank_model, rank_tokenizer, task_descs, task_names, teacher_responses, model_inputs, original_inputs, original_outputs, model_outputs, eval_preds, inference_config):
